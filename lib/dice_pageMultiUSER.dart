...
class DicePageMulti extends StatefulWidget {
  const DicePageMulti({required userID, required gameSessionID, super.key});

  @override
  State<DicePageMulti> createState() => _DicePageStateMulti();
}

class _DicePageStateMulti extends State<DicePageMulti> with SingleTickerProviderStateMixin {
  // ───────────────────────────────────────────────────────────────────────────
  // State fields
